...
//         assert(double_equal(unwrap_double(wrapper_double), i));
//     }
//     list_destroy(list);
...
//     assert(double_equal(unwrap_double(wrapper_double), 9.0));
...
//     assert(double_equal(unwrap_double(wrapper_double), 7.0));
//     list_destroy(list);
...
//     for (int i = 0; i < 5; i++) {
//         wrapper_double_t *wrapper_double = (wrapper_double_t *)list_get(list, i);
//         assert(double_equal(unwrap_double(wrapper_double), 5 - i - 1));
//     }
//     list_destroy(list);
...
//         assert(double_equal(unwrap_double(wrapper), arr[i]));
//     }
//     list_destroy(list);
...
//     while (iter) {
//         assert(double_equal(*(double *)iter, 5 - i - 1));
//         iter = list_iter_prev(list);
//         i++;
//     }
//     assert(i == 5);
...
//     while (iter) {
//         assert(double_equal(*(double *)iter, i));
//         iter = list_iter_next(list);
//         i++;
//     }
//     assert(i == 5);
